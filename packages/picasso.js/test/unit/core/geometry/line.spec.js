...
describe('GeoLine', () => {
  describe('constructor', () => {
    ...
    it('should set the correct values when arguments passed', () => {
      const l = new GeoLine({ x1: 1, y1: 2, x2: 3, y2: 4, tolerance: 5 });
  ...
  describe('set', () => {
    it('should set the correct values', () => {
      const l = new GeoLine();
      l.set({ x1: 6, y1: 7, x2: 8, y2: 9, tolerance: 10 });
    ...
    it('should handle no arguments', () => {
      const l = new GeoLine({ x1: 6, y1: 7, x2: 8, y2: 9, tolerance: 10 });
      l.set();
  ...
  describe('points', () => {
    it('should return the correct points', () => {
      const l = new GeoLine({ x1: 5, y1: 6, x2: 7, y2: 8 }),
        points = l.points();
  ...
  describe('Intersection', () => {
    describe('Point', () => {
      it('should intersect point on a horizontal line segment', () => {
        const line = new GeoLine({ x1: 1, y1: 3, x2: 5, y2: 3 });
        const p = { x: 4, y: 3 };
        const start = { x: 1, y: 3 };
        const end = { x: 1, y: 3 };
      ...
      it('should intersect point on a vertical line segment', () => {
        const line = new GeoLine({ x1: 3, y1: 1, x2: 3, y2: 5 });
        const p = { x: 3, y: 3 };
        const start = { x: 3, y: 1 };
        const end = { x: 3, y: 5 };
      ...
      it('should intersect point on a angled line segment', () => {
        const line = new GeoLine({ x1: -3, y1: 0, x2: 0, y2: 3 });
        const p = { x: -2, y: 1 };
        const start = { x: -3, y: 0 };
        const end = { x: 0, y: 3 };
      ...
      it('should intersect point with tolerance on line segment', () => {
        const line = new GeoLine({ x1: 0, y1: 0, x2: 3, y2: 3, tolerance: 2 });
        const p = { x: 4, y: 3 };
        const start = { x: -1, y: -1 };
        const end = { x: 4, y: 4 };
      ...
      it('should not intersect point if line segment has zero size', () => {
        const line = new GeoLine({ x1: 1, y1: 1, x2: 1, y2: 1 });
        const p1 = { x: 4, y: 3 };
        const p2 = { x: 1, y: 1 };
    ...
    describe('Line', () => {
      it('should intersect perpendicular axis-aligned line segments', () => {
        const line = new GeoLine({ x1: 4, y1: 0, x2: 4, y2: 6 }); // y-axis aligned
      ...
      it('should intersect perpendicular non-axis-aligned line segments', () => {
        const line = new GeoLine({ x1: -3, y1: -3, x2: 3, y2: 3 });
      ...
      it('should intersect non-perpendicular non-axis-aligned line segments', () => {
        const line = new GeoLine({ x1: 0, y1: 0, x2: 3, y2: 3 });
      ...
      it('should intersect collinear axis-aligned line segments', () => {
        const line = new GeoLine({ x1: 0, y1: 0, x2: 0, y2: 5 });
      ...
      it('should not intersect if any of the line segment has zero size', () => {
        ...
        const line3 = new GeoLine({ x1: 0, y1: 0, x2: 1, y2: 1 });
    ...
    describe('Rect', () => {
      it('should intersect if line is inside rect', () => {
        const line = new GeoLine({ x1: 0, y1: 0, x2: 5, y2: 5 });
      ...
      it('should intersect if start or end of line is inside rect', () => {
        const line = new GeoLine({ x1: -10, y1: -10, x2: 5, y2: 5 });
        const line2 = new GeoLine({ x1: 5, y1: 5, x2: 15, y2: 15 });
        const rectVertices = [{ x: -1, y: -1 }, { x: 6, y: -1 }, { x: 6, y: 6 }, { x: -1, y: 6 }];
      ...
      it('should intersect if line is collinear with rect circumference', () => {
        const line = new GeoLine({ x1: -1, y1: 0, x2: 5, y2: 0 }); // end on rect circumference
        const line2 = new GeoLine({ x1: -1, y1: 0, x2: 15, y2: 0 }); // start and end outside rect circumference
      ...
      it('should intersect if line is coincident with rect circumference', () => {
        const line = new GeoLine({ x1: 0, y1: 0, x2: 6, y2: 0 });
        const line2 = new GeoLine({ x1: 0, y1: 6, x2: 0, y2: 0 });
        const rectVertices = [{ x: 0, y: 0 }, { x: 6, y: 0 }, { x: 6, y: 6 }, { x: 0, y: 6 }];
      ...
      it('should intersect if line is axis-aligned and crossing rect', () => {
        const line = new GeoLine({ x1: 3, y1: -1, x2: 3, y2: 9 });
        const line2 = new GeoLine({ x1: -1, y1: 3, x2: 9, y2: 3 });
        const rectVertices = [{ x: 0, y: 0 }, { x: 6, y: 0 }, { x: 6, y: 6 }, { x: 0, y: 6 }];
      ...
      it('should intersect if line is non-axis-aligned and crossing rect', () => {
        const line = new GeoLine({ x1: -1, y1: -1, x2: 12, y2: 12 });
        const rectVertices = [{ x: 0, y: 0 }, { x: 6, y: 0 }, { x: 6, y: 6 }, { x: 0, y: 6 }];
      ...
      it('should intersect if line start or end is on rect circumference', () => {
        const line = new GeoLine({ x1: 6, y1: 6, x2: 12, y2: 12 });
        const line2 = new GeoLine({ x1: -3, y1: -3, x2: 0, y2: 0 });
        const rectVertices = [{ x: 0, y: 0 }, { x: 6, y: 0 }, { x: 6, y: 6 }, { x: 0, y: 6 }];
      ...
      it('should not intersect if line outside rect circumference', () => {
        const line = new GeoLine({ x1: 7, y1: 7, x2: 12, y2: 12 });
        const line2 = new GeoLine({ x1: -3, y1: -3, x2: -1, y2: -1 });
        const line3 = new GeoLine({ x1: -1, y1: 0, x2: -1, y2: 6 });
        const line4 = new GeoLine({ x1: 0, y1: -1, x2: 6, y2: -1 });
        const rectVertices = [{ x: 0, y: 0 }, { x: 6, y: 0 }, { x: 6, y: 6 }, { x: 0, y: 6 }];
      ...
      it('should not intersect if rect has zero size', () => {
        const line = new GeoLine({ x1: 0, y1: 0, x2: 1, y2: 1 });
    ...
    describe('Circle', () => {
      it('should intersect a collinear line that start or end inside circle circumference', () => {
        const line = new GeoLine({ x1: 0, y1: 0, x2: 12, y2: 12 });
        const line2 = new GeoLine({ x1: 12, y1: 12, x2: 30, y2: 30 });
      ...
      it('should intersect a collinear line that crosses the circle circumference', () => {
        const line = new GeoLine({ x1: 0, y1: 0, x2: 30, y2: 30 });
      ...
      it('should intersect a axis-aligned line that start or end inside circle circumference', () => {
        const line = new GeoLine({ x1: 0, y1: 9, x2: 11, y2: 9 });
        const line2 = new GeoLine({ x1: 9, y1: 11, x2: 9, y2: 30 });
      ...
      it('should intersect a axis-aligned line that crosses the circle circumference', () => {
        const line = new GeoLine({ x1: 0, y1: 7, x2: 15, y2: 7 });
        const line2 = new GeoLine({ x1: 7, y1: 0, x2: 7, y2: 15 });
        const c = { cx: 10, cy: 10, r: 3 };
      ...
      it('should not intersect a axis-aligned line outside the circle circumference', () => {
        const line = new GeoLine({ x1: 0, y1: 6, x2: 15, y2: 6 });
        const line2 = new GeoLine({ x1: 6, y1: 0, x2: 6, y2: 15 });
        const c = { cx: 10, cy: 10, r: 3 };
      ...
      it('should not intersect a collinear line that doesnt not cross or start/end on circle circumference', () => {
        const line = new GeoLine({ x1: 0, y1: 0, x2: 3, y2: 3 });
        const line2 = new GeoLine({ x1: 15, y1: 15, x2: 30, y2: 30 });
        const c = { cx: 10, cy: 10, r: 3 };
