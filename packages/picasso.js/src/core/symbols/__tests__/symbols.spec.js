    ...
    describe('Options', () => {
      it('width', () => {
        ...
        expect(symbol).to.deep.equal({
          ...
          strokeDasharray: '10 10',
          d:
            'M9.5 14.5 L9.5 -17 L10.5 -17 L10.5 14.5 L42 14.5 L42 15.5 L10.5 15.5 L10.5 47 L9.5 47 L9.5 15.5 L-22 15.5 L-22 14.5 Z',
        });
      });
    });
  });
  ...
  describe('n-polygon', () => {
    ...
    it('should output a n-polygon', () => {
      ...
      expect(symbol).to.deep.equal({
        ...
        strokeDasharray: '10 10',
        d: fixDecimals(
          'M26.000000000000004 -12.712812921102035 L-5.999999999999993 -12.712812921102042 L-22 14.999999999999996 L-6.000000000000014 42.71281292110203 L26.000000000000004 42.712812921102035 L42 15.000000000000007 Z'
        ),
      });
    });
    ...
    describe('Options', () => {
      it('sides', () => {
        ...
        expect(symbol).to.deep.equal({
          ...
          strokeDasharray: '10 10',
          d: fixDecimals(
            'M19.88854381999832 -15.433808521444913 L-15.888543819998315 -3.809128073359144 L-15.888543819998318 33.80912807335913 L19.88854381999831 45.43380852144492 L42 15.000000000000007 Z'
          ),
        });
      });
      ...
      it('startAngle', () => {
        ...
        expect(symbol).to.deep.equal({
          ...
          strokeDasharray: '10 10',
          d: fixDecimals(
            'M1.7177905567193328 -15.909626441250186 L-20.909626441250182 6.7177905567193275 L-12.627416997969526 37.62741699796952 L18.28220944328065 45.90962644125019 L40.90962644125018 23.282209443280664 L32.627416997969526 -7.627416997969515 Z'
          ),
        });
      });
    });
  ...
  describe('Saltire', () => {
    ...
    it('should output a saltire', () => {
      ...
      expect(symbol).to.deep.equal({
        ...
        strokeDasharray: '10 10',
        d:
          'M-1.3137084989847594 15 L-23.213971311334014 -6.900262812349258 L-11.900262812349254 -18.21397131133402 L10 3.6862915010152406 L31.900262812349258 -18.213971311334014 L43.21397131133402 -6.900262812349254 L21.31370849898476 15 L43.213971311334014 36.900262812349254 L31.900262812349254 48.21397131133402 L10 26.31370849898476 L-11.900262812349258 48.213971311334014 L-23.21397131133402 36.900262812349254 Z',
      });
    });
    ...
    describe('Options', () => {
      it('width', () => {
        ...
        expect(symbol).to.deep.equal({
          ...
          strokeDasharray: '10 10',
          d:
            'M9.292893218813452 15 L-22.075873206958377 -16.368766425771835 L-21.36876642577183 -17.075873206958384 L10 14.292893218813452 L41.36876642577184 -17.075873206958377 L42.075873206958384 -16.36876642577183 L10.707106781186548 15 L42.07587320695838 46.36876642577184 L41.36876642577183 47.075873206958384 L10 15.707106781186548 L-21.368766425771835 47.07587320695838 L-22.075873206958384 46.36876642577183 Z',
        });
      });
    });
  });
    ...
    describe('Options', () => {
      ...
      it('direction - down', () => {
        ...
        expect(symbol).to.deep.equal({
          ...
          strokeDasharray: '10 10',
          d:
            'M42.00000000000001 -16.999999999999996 L9.999999999999996 47 L-21.999999999999996 -17.000000000000007 L42.00000000000001 -16.999999999999996 Z',
        });
      });
