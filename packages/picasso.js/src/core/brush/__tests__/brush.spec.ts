...
describe('brush', () => {
  ...
  beforeEach(() => {
    b = brush({ vc: vcf as any, rc: rcf as any }) as ReturnType<typeof brush>;
  ...
  describe('addValue', () => {
    ...
    beforeEach(() => {
      ...
      bb = brush({ vc: vcc as any, rc: noop as any }) as ReturnType<typeof brush>;
    });
  ...
  function testRange(action: string): void {
    ...
    describe(fn, () => {
      ...
      beforeEach(() => {
        ...
        bb = brush({ rc: rcc as any, vc: noop as any }) as ReturnType<typeof brush>;
  ...
  describe('containsRangeValue', () => {
    ...
    beforeEach(() => {
      ...
      rcc = sandbox.stub().returns(v);
      bb = brush({ vc: noop as any, rc: rcc as any }) as ReturnType<typeof brush>;
    ...
    it('should return true when given value exists', () => {
      ...
      expect(bb.containsRangeValue('speed', 'some range' as any)).to.equal(true);
    ...
    it('should return true when given value exists for an aliased key', () => {
      ...
      v.containsValue.returns(true);
      expect(bb.containsRangeValue('_range-ali', 'some range' as any)).to.equal(true);
      expect(bb.containsRangeValue('margin', 'some range' as any)).to.equal(true);
      expect(v.containsValue).to.have.been.calledWith('some range');
    });
    ...
    it('should return false when given value does not exist', () => {
      ...
      expect(bb.containsRangeValue('speed', 'very fast' as any)).to.equal(false);
  ...
  describe('containsRange', () => {
    ...
    it('should return true when given value exists', () => {
      ...
      expect(bb.containsRange('speed', 'some range' as any)).to.equal(true);
    ...
    it('should return true when given value exists for an aliased key', () => {
      bb.addRange('_range-ali');
      v.containsRange.returns(true);
      expect(bb.containsRange('_range-ali', 'some range' as any)).to.equal(true);
      expect(bb.containsRange('margin', 'some range' as any)).to.equal(true);
      expect(v.containsRange).to.have.been.calledWith('some range');
    });
    ...
    it('should return false when given value does not exist', () => {
      ...
      expect(bb.containsRange('speed', 'very fast' as any)).to.equal(false);
  ...
  describe('containsData', () => {
    ...
    beforeEach(() => {
      ...
      bb = brush({ vc: vcc as any, rc: rcc as any }) as ReturnType<typeof brush>;
      d = {
  ...
  describe('interceptors', () => {
    ...
    let interceptor: sinon.SinonStub;
    beforeEach(() => {
      cb = sandbox.spy();
      b.on('update', cb);
