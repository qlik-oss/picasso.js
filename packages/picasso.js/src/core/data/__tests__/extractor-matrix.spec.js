    ...
    expect(m).to.eql([
      {
        ...
        text: { value: '(SE)', label: '(SE)', source: { field: 'fkey', key: 'nyckel' } },
      },
      {
        value: 'IT',
        label: 'IT',
        source: { field: 'fkey', key: 'nyckel' },
        text: { value: '(IT)', label: '(IT)', source: { field: 'fkey', key: 'nyckel' } },
      },
      {
        value: 'SE',
        label: 'SE',
    ...
    expect(m).to.eql([
      {
        ...
        label: 'SE',
        source: { field: 'fkey', key: 'nyckel' },
        num: { value: 3, label: '3', source: { field: 'fkey2', key: 'nyckel' } },
      },
      {
        value: 'IT',
        label: 'IT',
        source: { field: 'fkey', key: 'nyckel' },
        num: { value: 7, label: '7', source: { field: 'fkey2', key: 'nyckel' } },
      },
      {
        value: 'SE',
        label: 'SE',
        source: { field: 'fkey', key: 'nyckel' },
        num: { value: 2, label: '2', source: { field: 'fkey2', key: 'nyckel' } },
      },
    ]);
  });
