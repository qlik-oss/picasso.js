...
describe('svg-gradient', () => {
  ...
  describe('onCreate', () => {
    it('should set fillReference when fill is a gradient', () => {
      ...
      expect(state.node.fillReference).to.equal("url('http://localhost/#picasso-gradient-13-2')");
    });
    ...
    it('should set strokeReference when stroke is a gradient', () => {
      ...
      expect(state.node.strokeReference).to.equal("url('http://localhost/#picasso-gradient-13-2')");
    });
