...
declare namespace picassojs {
  ...
  interface Chart {
     ...
     */
    shapesAt(
      shape: picassojs.Line | picassojs.Rect | picassojs.Point | picassojs.Circle,
      opts: {
        components?: {}[];
        propagation?: string;
      }
  ...
  namespace ComponentLabels {
    ...
    type Source = {
      ...
      selector: string;
      strategy:
        | picassojs.ComponentLabels.BarsLabelStrategy
        | picassojs.ComponentLabels.RowsLabelStrategy
        | picassojs.ComponentLabels.SlicesLabelStrategy;
    };
  }
  ...
  type ComponentTooltip = {
    settings: {
       ...
       */
      beforeHide?(ctx: { element: HTMLElement }): void;
      /**
       ...
       */
      content?(ctx: { data: any[]; h: object }): object[];
      contentClass?: object;
      delay?: number;
      direction?: string;
      duration?: number;
       ...
       * @param ctx Callback context
       */
      extract?(ctx: { node: picassojs.SceneNode }): any;
      /**
  ...
  interface Renderer {
    ...
    itemsAt(
      geometry:
        ...
        | picassojs.Line
        | picassojs.Polygon
        | picassojs.Geopolygon
    ): picassojs.SceneNode[];
    /**
     * @param opts
     */
    measureText(opts: { text: string; fontSize: string; fontFamily: string }): object;
    /**
